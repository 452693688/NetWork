...
import com.ui.activity.BaseApplication;
...
public class FileUtile {
    ...
    //-----------------------------------------------------//
    public final static String WLTLIB = CFG_PATH_SDCARD_ROOT + File.separator + "wltlib";
    //身份证读取的照片
    public final static String HEAD_URL = FileUtile.WLTLIB + File.separator + "zp.bmp";
